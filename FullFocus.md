...
- При нажатии на "Перейти в корзину" действительно выполняется редирект.  
...
Файл действительно в новой папке:  

![Restored into new folder](img/restored_into_new_folder.png)

- Создавая новую папку, введем слишком длинное имя (больше 255 символов).  
...
![Blank folder name error_](img/blank_folder_name_error_.png)
