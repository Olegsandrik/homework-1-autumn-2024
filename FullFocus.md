...
* Изменения в имени, фамилии, никнейме и городе подразумевают пользовательский ввод. После изменения данных нужно нажать синюю кнопку **сохранить**. Никаких сообщений об успешном сохранении изменений нет, ориентироваться приходиться только по имени и фото в левой части экрана. Кнопка **отменить** возвращает на главную страницу профиля.
...
* При вводе названия города, приложение подсказывает названия выпадающим списком, ориентируясь на введенные буквы. Однако можно проигнорировать подсказки и ввести название несуществующего города, о чем будет выведено сообщение.
...
* Открывается окно выбора файла для фото профиля и после его загрузки появляется окно для позиционирования новой фотографии. Можно **сохранить** или **отменить** изменения.
...
* Там же в правом верхнем углу рядом с аватаркой есть кнопка **ваши заметки**. При нажатии появляется модальное окно, с помощью которого можно сделать быстрое действие в одном из сторонних сервисовЖ **Календарь**, **Заметки**, **Погода**, **Покупки**, **Задачи**. При взаимодействии с любым из сервисов он открывается в новой вкладке браузера.

![main_page_services](img/main_page_services.png)
...
* При создании **документа** или **таблицы** происходит перенаправление в отдельную вкладку с приложением *офис*. При  создании папки открывается модальное окно для задания имени:
...
* нажатие на значок сердца у файла или папки добавляет его в избранное (значок отображается при наведении); это также можно сделать, нажав правой кнопкой мыши на нужный файл или папку и выбрав “Добавить в избранное”  
